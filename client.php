...
<form class="row container user_form">
    <div class="row">
    ...
    <div class="col l12 pass_change">
        ...
        <div class="row container">
            <div class="input-field col l6 center">
                <input id="current_pass" type="text" class="validate">
                <label for="current_pass">Current Password</label>
            </div>
        </div>
        <div class="row container">
            <div class="input-field col l6 center">
                <input id="new_pass" type="text" class="validate">
                <label for="new_pass">New Password</label>
            </div>
        </div>
        <div class="row container">
            <div class="col l3">
                <a class="waves-effect waves-light btn z-depth-3">Submit</a>
            </div>
        </div>
    </div>
<hr>
...
<div class="row container">
    <form class="col s12">
        <div class="row">
            ...
            <div class="input-field col l3">
                <input id="fname_account" type="text" class="validate">
                <label for="fname_account">First Name</label>
            </div>
            ...
            <div class="input-field col l3">
                <input id="lname_account" type="text" class="validate">
                <label for="lname_account">Last Name</label>
            </div>
